# Magic Square based on TDD using TypeScript and Mocha
...
## How to run
First install packages by running command `npm install`.

Then simply type `npm run test` and all tests will be run.
